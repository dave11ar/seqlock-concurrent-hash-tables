...
struct constructor_throwable {
  constructor_throwable() noexcept : value(0) {}

  constructor_throwable(uint32_t value) : value(value) {}

  constructor_throwable(const constructor_throwable& a) : value(a.value) {}

  explicit operator uint32_t() {
    return value;
  }

  bool operator<=(const constructor_throwable& other) const {
    return value < other.value;
  }

  constructor_throwable& operator=(const constructor_throwable& a) {
    value = a.value;
    return *this;
  }

  constructor_throwable& operator+=(uint32_t v) {
    value += v;
    return *this;
  }
  ...
  constructor_throwable& operator++() {
    ++value;
    return *this;
  }
  constructor_throwable operator++(int) {
    constructor_throwable result(*this);
    ++result;
    return result;
  }
  ...
  friend Outstream& operator<<(Outstream& out, const constructor_throwable& a) {
    out << a.value;
    return out;
  }

  struct hash {
    size_t operator()(const constructor_throwable& a) const {
